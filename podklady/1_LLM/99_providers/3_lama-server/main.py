"""
llama-server Demo — basic chat, streaming, and tool calls with Qwen3.5-9B
Uses the OpenAI-compatible API exposed by llama-server at localhost:8001.
Requires --jinja flag on the server for tool call support.
"""
