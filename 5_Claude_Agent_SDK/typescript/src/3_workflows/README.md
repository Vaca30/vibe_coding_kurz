...
**Example:** Research the benefits of TypeScript's type system, analyze the findings, then produce an executive summary.
...
**When to use:** Multi-perspective analysis where specialists are independent and can run concurrently. Uses `Promise.all()` for parallel execution.
